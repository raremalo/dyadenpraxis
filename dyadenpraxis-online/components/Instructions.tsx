    ...
    <div className="min-h-screen bg-[var(--c-bg-app)] text-[var(--c-text-main)] p-6 md:p-12">
      <div className="max-w-2xl mx-auto space-y-8 fade-in">
        ...
        <div className="space-y-8 font-light leading-relaxed text-lg">
          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Was ist eine Dyade?</h2>
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Der Ablauf</h2>
            <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
              <li>Ihr werdet verbunden. Einer ist der <strong className="font-medium text-[var(--c-text-main)]">Sprecher</strong>, einer der <strong className="font-medium text-[var(--c-text-main)]">Zuhörer</strong>.</li>
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Die Haltung</h2>
            <p className="text-[var(--c-text-muted)]">
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Geschichte & Ursprung</h2>
            <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
              <li>Die Dyadenpraxis (von griechisch "Dyade" = Zweiheit) ist eine Form der kontemplativen Kommunikation.</li>
              <li>Entwickelt in den 1960er Jahren von <span className="font-medium text-[var(--c-text-main)]">Charles Berner</span> als Teil seiner "Mind Clearing" Technik.</li>
              <li>Herzstück des <span className="font-medium text-[var(--c-text-main)]">Enlightenment Intensive</span> — 10–14 tägige Retreats mit 10–12 Dyaden pro Tag.</li>
              <li>Heute wissenschaftlich fundiert durch das <span className="font-medium text-[var(--c-text-main)]">ReConnect! Programm</span> von Prof. Dr. Tania Singer.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Drei Hauptformen</h2>
            <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
              <li>
                <span className="font-medium text-[var(--c-text-main)]">Klassische Dyaden (Enlightenment Intensive)</span>: 40 Min pro Dyade (8x 5 Min), existenzielle Fragen ("Wer bin ich?", "Was ist Leben?"), intensive Retreat-Struktur.
              </li>
              <li>
                <span className="font-medium text-[var(--c-text-main)]">Kontemplative Dyaden (Achtsamkeit)</span>: 2x 2 Min oder 2x 5 Min, thematische Leitfragen zu Stress, Gefühlen, Präsenz, flexibel in Workshops.
              </li>
              <li>
                <span className="font-medium text-[var(--c-text-main)]">ReConnect! Dyaden (Wissenschaftlich)</span>: Tägliche Praxis über 8 Wochen, drei Typen (Affekt-, Perspektiv-, Mitgefühls-Dyaden), wechselnde Partner per App.
              </li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Die vier Säulen</h2>
            <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
          ...
          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Wissenschaftliche Grundlagen</h2>
            <p className="text-[var(--c-text-muted)] mb-3">
            ...
            <p className="text-[var(--c-text-muted)] mt-3">
              Im Gegensatz zu Meditation alleine verbinden Dyaden kontemplative Praxis mit sozialer Interaktion.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-medium mb-3 text-[var(--c-text-main)]">Erweiterte Rollenverteilung</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-base font-medium text-[var(--c-text-main)] mb-2">Sprecher:in — Was zu tun ist</h3>
                <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
              ...
              <div>
                <h3 className="text-base font-medium text-[var(--c-text-main)] mb-2">Sprecher:in — Was zu vermeiden ist</h3>
                <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
              ...
              <div>
                <h3 className="text-base font-medium text-[var(--c-text-main)] mb-2">Zuhörer:in — Was zu tun ist</h3>
                <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
              ...
              <div>
                <h3 className="text-base font-medium text-[var(--c-text-main)] mb-2">Zuhörer:in — Was zu vermeiden ist</h3>
                <ul className="list-disc pl-5 space-y-2 text-[var(--c-text-muted)]">
                  <li>Unterbrechen</li>
