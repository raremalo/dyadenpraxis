/**
 * Kanonischer Fragen-Katalog für Dyaden-Prompts — single source of truth,
 * gemeinsam konsumiert von Vite-Client (data/dyadQuestions.ts) und
 * Vercel-API-Route (api/generate-prompt.ts). Beide bündeln relative Imports
 * (Architecture-Review L5-01 — vorher doppelt gepflegt mit Drift).
 */
